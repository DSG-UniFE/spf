...
public class NodePath {
    ...
    public static NodePath read (CommHelper commHelper)
    {
        try {
            ...
            String pathID = (len > 0 ? new String (commHelper.receiveBlob(len)) : null);
            ...
            for (int i = 0; i < nWayPoints; i++) {
                ...
                String location = (len > 0 ? new String (commHelper.receiveBlob(len)) : null);
    ...
    public boolean write (CommHelper commHelper)
    {
        try {
            ...
            if (pathId.length() > 0) {
                commHelper.sendBlob (pathId.getBytes(), 0, pathId.length());
            }
            ...
            for (Waypoint w : waypoints) {
                ...
                if (locationLen > 0) {
                    commHelper.sendBlob (location.getBytes(), 0, locationLen);
                }
