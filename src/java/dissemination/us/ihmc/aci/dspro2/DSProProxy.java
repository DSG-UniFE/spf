...
public class DSProProxy extends ConcurrentProxy implements CtrlMsgListener, MatchmakingLogListener,
        DSProProxyListener, SearchListener, Fragmenter, Reassembler
{
            ...
            throws CommException
    {
        if (_mimeTypeToFragmenter.containsKey(dataMimeType)) {
            ...
            return addChunkedMessage(groupName, objectId, instanceId, xmlMedatada, chunks, dataMimeType, expirationTime);
        }
    ...
    public String getNodeContext(String nodeId) throws CommException
    {
        ...
        synchronized (this) {
            try {
                ...
                byte[] b = nodeId == null ? "".getBytes() : nodeId.getBytes();
