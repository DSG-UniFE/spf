...
public class DSProProxyCallbackHandler extends ConcurrentProxyCallbackHandler
{
    ...
    public void doFragment() throws CommException, ProtocolException
    {
        ...
        byte[] b = _commHelper.receiveBlock();
        String inputMimeType = b != null ? new String (b) : null;
        b = _commHelper.receiveBlock();
        String outputMimeType = b != null ? new String (b) : null;
        ...
        for (ChunkWrapper chunk : chunks) {
            ...
            ((us.ihmc.aci.util.chunking.ChunkWrapper)chunk).write (_commHelper);
        }
    ...
    public void doReassemble() throws CommException, ProtocolException
    {
        ...
        byte[] b = _commHelper.receiveBlock();
        final String mimeType = (b != null ? new String (b) : null);
        
        byte chunkId = 0;
        Collection<ChunkWrapper> chunks = new LinkedList<>();
        do {
        ...
        Collection<AnnotationWrapper> annotations = new LinkedList<>();
